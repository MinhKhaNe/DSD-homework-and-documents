module test_bench15;
    ...
    begin
        if(e != expected_result || f != expected_result || g != expected_result) begin
            ...
            $display("===== t=%d Expected value is %2d, Actual gate_model value is %2d, Actual dataflow value is %2d, Actual behavioral_model value is %2d =====", 
                      $time, expected_result, e, f, g);
        end
        else begin
    ...
    begin
        if(i != expected_carry || j != expected_carry || k != expected_carry) begin
            ...
            $display("===== t=%d Expected value is %b, Actual gate_model value is %b, Actual dataflow value is %b, Actual behavioral_model value is %b =====", 
                      $time, expected_carry, i, j, k);
        end
        else begin
            $display("===== t=%d PASSED SUCCESSFULLY =====", $time);
        end
